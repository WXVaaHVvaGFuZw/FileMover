...
class FileMoverApp:
    def __init__(self, master):
        ...
        self.setting_menu.add_command(label="Select Source Path", command=self.select_setting_path)
        ...
        tk.Button(self.move_path_frame, text="Select Path", command=self.select_path).grid(row=0, column=0, padx=(0, 10))
